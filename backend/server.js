...
app.post('/api/encomendas', async (req, res) => {
    ...
    try {
        ...
        const { cliente_nome, cliente_numero, endereco, numero, forma_pagamento, produtos, data_encomenda } = req.body;

        // 1. Inserir a nova encomenda na tabela 'encomendas'
        const encomendaRes = await client.query(
            `INSERT INTO encomendas (cliente_nome, cliente_numero, endereco, numero, forma_pagamento, status_encomenda, data_encomenda)
             VALUES ($1, $2, $3, $4, $5, $6, $7)
             RETURNING id`,
            [cliente_nome, cliente_numero, endereco, numero, forma_pagamento, 'Aceitar', data_encomenda]
        );
